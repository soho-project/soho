 ...
 * @author i
 */
@Api(value = "guest AI应用", tags = "guest AI应用")
@RequiredArgsConstructor
@RestController
@RequestMapping("ai/guest/aiApp" )
public class GuestAiAppController {
     ...
     */
    @GetMapping("/list")
    @Node(value = "guest::aiApp::list", name = "获取 AI应用 列表")
    @ApiOperation(value = "guest 获取 AI应用 列表", notes = "guest 获取 AI应用 列表")
     ...
     */
    @GetMapping(value = "/{id}" )
    @Node(value = "guest::aiApp::getInfo", name = "获取 AI应用 详细信息")
    @ApiOperation(value = "guest 获取 AI应用 详细信息", notes = "guest 获取 AI应用 详细信息")
     ...
     */
    @PostMapping
    @Node(value = "guest::aiApp::add", name = "新增 AI应用")
    @ApiOperation(value = "guest 新增 AI应用", notes = "guest 新增 AI应用")
     ...
     */
    @PutMapping
    @Node(value = "guest::aiApp::edit", name = "修改 AI应用")
    @ApiOperation(value = "guest 修改 AI应用", notes = "guest 修改 AI应用")
     ...
     */
    @DeleteMapping("/{ids}" )
    @Node(value = "guest::aiApp::remove", name = "删除 AI应用")
    @ApiOperation(value = "guest 删除 AI应用", notes = "guest 删除 AI应用")
