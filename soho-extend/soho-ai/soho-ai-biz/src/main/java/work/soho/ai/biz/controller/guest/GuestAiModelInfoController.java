 ...
 * @author fang
 */
@Api(value = "guest AI模型", tags = "guest AI模型")
@RequiredArgsConstructor
@RestController
@RequestMapping("ai/guest/aiModelInfo" )
public class GuestAiModelInfoController {
     ...
     */
    @GetMapping("/list")
    @Node(value = "guest::aiModelInfo::list", name = "获取 AI模型 列表")
    @ApiOperation(value = "guest 获取 AI模型 列表", notes = "guest 获取 AI模型 列表")
     ...
     */
    @GetMapping(value = "/{id}" )
    @Node(value = "guest::aiModelInfo::getInfo", name = "获取 AI模型 详细信息")
    @ApiOperation(value = "guest 获取 AI模型 详细信息", notes = "guest 获取 AI模型 详细信息")
