...
@RestController
@RequestMapping("/guest/shopInfo" )
public class GuestShopInfoController {
     ...
     */
    @GetMapping("/list")
    @Node(value = "guest::shopInfo::list", name = "获取 店铺信息 列表")
     ...
     */
    @GetMapping(value = "/{id}" )
    @Node(value = "guest::shopInfo::getInfo", name = "获取 店铺信息 详细信息")
     ...
     */
    @PostMapping
    @Node(value = "guest::shopInfo::add", name = "新增 店铺信息")
     ...
     */
    @PutMapping
    @Node(value = "guest::shopInfo::edit", name = "修改 店铺信息")
     ...
     */
    @DeleteMapping("/{ids}" )
    @Node(value = "guest::shopInfo::remove", name = "删除 店铺信息")
     ...
     */
    @GetMapping("options")
    @Node(value = "guest::shopInfo::options", name = "获取 店铺信息 选项")
