...
@RestController
@RequestMapping("/shop/guest/shopOrderSku" )
public class GuestShopOrderSkuController {
     ...
     */
    @GetMapping("/list")
    @Node(value = "guest::shopOrderSku::list", name = "获取 订单SKU 列表")
     ...
     */
    @GetMapping(value = "/{id}" )
    @Node(value = "guest::shopOrderSku::getInfo", name = "获取 订单SKU 详细信息")
     ...
     */
    @PostMapping
    @Node(value = "guest::shopOrderSku::add", name = "新增 订单SKU")
     ...
     */
    @PutMapping
    @Node(value = "guest::shopOrderSku::edit", name = "修改 订单SKU")
     ...
     */
    @DeleteMapping("/{ids}" )
    @Node(value = "guest::shopOrderSku::remove", name = "删除 订单SKU")
