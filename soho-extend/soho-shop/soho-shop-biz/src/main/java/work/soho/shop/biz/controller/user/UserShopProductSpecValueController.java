...
@RestController
@RequestMapping("/shop/user/shopProductSpecValue" )
public class UserShopProductSpecValueController {
     ...
     */
    @GetMapping("/list")
    @Node(value = "user::shopProductSpecValue::list", name = "获取 商品规格值 列表")
     ...
     */
    @GetMapping(value = "/{id}" )
    @Node(value = "user::shopProductSpecValue::getInfo", name = "获取 商品规格值 详细信息")
     ...
     */
    @PostMapping
    @Node(value = "user::shopProductSpecValue::add", name = "新增 商品规格值")
     ...
     */
    @PutMapping
    @Node(value = "user::shopProductSpecValue::edit", name = "修改 商品规格值")
     ...
     */
    @DeleteMapping("/{ids}" )
    @Node(value = "user::shopProductSpecValue::remove", name = "删除 商品规格值")
