...
@RestController
@RequestMapping("/shop/user/shopProductCategory" )
public class UserShopProductCategoryController {
     ...
     */
    @GetMapping("/list")
    @Node(value = "user::shopProductCategory::list", name = "获取 商品分类 列表")
     ...
     */
    @GetMapping(value = "/{id}" )
    @Node(value = "user::shopProductCategory::getInfo", name = "获取 商品分类 详细信息")
     ...
     */
    @PostMapping
    @Node(value = "user::shopProductCategory::add", name = "新增 商品分类")
     ...
     */
    @PutMapping
    @Node(value = "user::shopProductCategory::edit", name = "修改 商品分类")
     ...
     */
    @DeleteMapping("/{ids}" )
    @Node(value = "user::shopProductCategory::remove", name = "删除 商品分类")
