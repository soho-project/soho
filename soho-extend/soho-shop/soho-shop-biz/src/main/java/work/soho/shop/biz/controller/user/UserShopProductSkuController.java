...
@RestController
@RequestMapping("/shop/user/shopProductSku" )
public class UserShopProductSkuController {
     ...
     */
    @GetMapping("/list")
    @Node(value = "user::shopProductSku::list", name = "获取  列表")
     ...
     */
    @GetMapping(value = "/{id}" )
    @Node(value = "user::shopProductSku::getInfo", name = "获取  详细信息")
     ...
     */
    @PostMapping
    @Node(value = "user::shopProductSku::add", name = "新增 ")
     ...
     */
    @PutMapping
    @Node(value = "user::shopProductSku::edit", name = "修改 ")
     ...
     */
    @DeleteMapping("/{ids}" )
    @Node(value = "user::shopProductSku::remove", name = "删除 ")
