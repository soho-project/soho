...
@RestController
@RequestMapping("/user/openDoc" )
public class UserOpenDocController {
     ...
     */
    @GetMapping("/list")
    @Node(value = "user::openDoc::list", name = "获取 开放平台文档 列表")
     ...
     */
    @GetMapping(value = "/{id}" )
    @Node(value = "user::openDoc::getInfo", name = "获取 开放平台文档 详细信息")
     ...
     */
    @PostMapping
    @Node(value = "user::openDoc::add", name = "新增 开放平台文档")
     ...
     */
    @PutMapping
    @Node(value = "user::openDoc::edit", name = "修改 开放平台文档")
     ...
     */
    @DeleteMapping("/{ids}" )
    @Node(value = "user::openDoc::remove", name = "删除 开放平台文档")
