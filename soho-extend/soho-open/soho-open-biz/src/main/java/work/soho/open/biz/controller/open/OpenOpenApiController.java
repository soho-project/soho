...
public class OpenOpenApiController {
     ...
     */
    @GetMapping("/list")
    @Node(value = "open::openApi::list", name = "获取 开放平台api 列表")
     ...
     */
    @GetMapping(value = "/{id}" )
    @Node(value = "open::openApi::getInfo", name = "获取 开放平台api 详细信息")
     ...
     */
    @PostMapping
    @Node(value = "open::openApi::add", name = "新增 开放平台api")
     ...
     */
    @PutMapping
    @Node(value = "open::openApi::edit", name = "修改 开放平台api")
     ...
     */
    @DeleteMapping("/{ids}" )
    @Node(value = "open::openApi::remove", name = "删除 开放平台api")
     ...
     */
    @GetMapping("options")
    @Node(value = "open::openApi::options", name = "获取 开放平台api 选项")
