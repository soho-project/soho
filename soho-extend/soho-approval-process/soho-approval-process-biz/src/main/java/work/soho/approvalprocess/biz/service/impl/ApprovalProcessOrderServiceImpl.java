...
import work.soho.approvalprocess.biz.mapper.ApprovalProcessOrderMapper;
...
public class ApprovalProcessOrderServiceImpl extends ServiceImpl<ApprovalProcessOrderMapper, ApprovalProcessOrder>
    implements ApprovalProcessOrderService, ApprovalProcessOrderApiService {
    ...
    public void approve(Long userId, ApprovalProcessOrderNode approvalProcessOrderNode, ApprovalProcessOrderNodeApplyStatusEnum applyStatus, Long insertUserId) {
        ...
        nodes.forEach(item->{
            if(item.getUserId().equals(userId)) {
                ...
                ApprovalProcessOrderDto approvalProcessOrderDto = BeanUtils.copy(approvalProcessOrder, ApprovalProcessOrderDto.class);

                ApprovalEvent approvalEvent = new ApprovalEvent(approvalProcessOrderDto);
    ...
    @Override
    public ApprovalProcessOrderDto push(ApprovalProcessOrderVo approvalProcessOrderVo) {
        ApprovalProcessOrder approvalProcessOrder = create(approvalProcessOrderVo);
        return BeanUtils.copy(approvalProcessOrder, ApprovalProcessOrderDto.class);
    }
}
